  ...
  attributes: {
    alto: Schema.Attribute.Integer &
      ...
      Schema.Attribute.SetMinMax<
        ...
        number
      >;
    ancho: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    largo: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
...
export interface ApiMetodosDeEnvioMetodosDeEnvio
  extends Struct.CollectionTypeSchema {
  collectionName: 'metodos_de_envios';
  info: {
    displayName: 'metodos_de_envio';
    pluralName: 'metodos-de-envios';
    singularName: 'metodos-de-envio';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    informacion_adicional: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::metodos-de-envio.metodos-de-envio'
    > &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String &
      Schema.Attribute.Required &
    ...
    publishedAt: Schema.Attribute.DateTime;
    tarifa_fija: Schema.Attribute.Integer &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
        },
...
export interface ApiMetodosDePagoMetodosDePago
  extends Struct.CollectionTypeSchema {
  collectionName: 'metodos_de_pagos';
  info: {
    displayName: 'metodos_de_pago';
    pluralName: 'metodos-de-pagos';
    singularName: 'metodos-de-pago';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::metodos-de-pago.metodos-de-pago'
    > &
      Schema.Attribute.Private;
    nombre: Schema.Attribute.String &
      Schema.Attribute.Required &
...
export interface ApiOrdenDetalleOrdenDetalle
  extends Struct.CollectionTypeSchema {
  collectionName: 'orden_detalles';
  info: {
    displayName: 'orden_detalle';
    pluralName: 'orden-detalles';
    singularName: 'orden-detalle';
  };
  options: {
    draftAndPublish: false;
  };
  attributes: {
    ...
    publishedAt: Schema.Attribute.DateTime;
    snapshot_info_producto: Schema.Attribute.String & Schema.Attribute.Required;
    stock_ficticio: Schema.Attribute.Boolean & Schema.Attribute.Required;
...
export interface ApiOrdenOrden extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    costo_envio: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
    ...
    estado: Schema.Attribute.Enumeration<
      ['pendiente', 'pagada', 'preparacion', 'enviada', 'cancelada']
    > &
      Schema.Attribute.Required &
      Schema.Attribute.DefaultTo<'pendiente'>;
    fecha_de_pago: Schema.Attribute.DateTime;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::orden.orden'> &
      Schema.Attribute.Private;
    metodos_de_envio: Schema.Attribute.Relation<
      'manyToOne',
      'api::metodos-de-envio.metodos-de-envio'
    >;
    metodos_de_pago: Schema.Attribute.Relation<
      'manyToOne',
      'api::metodos-de-pago.metodos-de-pago'
    >;
...
export interface ApiProductoProducto extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    dimension: Schema.Attribute.Relation<
      ...
      'api::dimension.dimension'
    >;
    habilitar_stock: Schema.Attribute.Boolean &
      Schema.Attribute.Required &
    ...
    stock_disponible: Schema.Attribute.Integer &
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    stock_reservado: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
      ...
      > &
      Schema.Attribute.DefaultTo<0>;
    stock_total: Schema.Attribute.Integer &
      Schema.Attribute.Required &
      Schema.Attribute.SetMinMax<
        {
          min: 0;
